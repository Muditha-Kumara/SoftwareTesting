...
- Remaining gaps mostly in error branches and rare input scenarios.
- New tests targeted these areas, improving overall coverage.
...
- Coverage.py HTML report and logs (see attached screenshots).
- Example test logs and code snippets above.
