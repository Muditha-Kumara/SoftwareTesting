...
| **Group Members** | kumara([muditha.kumara@centria.fi](mailto:muditha.kumara@centria.fi)), Isiozor(chuks.isiozor@centria.fi) |
| **Date Submitted** | 20/10/2025 |
| **App Version/Commit** | Alpha 1.0 (MobileFoodDeliveryApp.zip) |
| **Code Repository** | https://github.com/Muditha-Kumara/SoftwareTesting/tree/2.1.part1 |
...
**Code Review Fixes Commit Reference:** [`f10c97a`](https://github.com/Muditha-Kumara/SoftwareTesting/commit/f10c97a) (generated via `git rev-parse --short HEAD`)
...
|---------------------|----------------------------------------|---------------------|-----------------------------------|
| main.py             | Unused PaymentProcessing import         | W0611               | Removed unused import             |
| main.py             | Unspecified encoding in open()          | W1514               | Added encoding parameter          |
...
| Restaurant_Browsing.py| Import position                       | C0413               | Moved import to top of file       |
| User_Registration.py | Import position                        | C0413               | Moved import to top of file       |

**Code Review Fixes Commit Reference:** [`0c6aa9f`](https://github.com/Muditha-Kumara/SoftwareTesting/commit/0c6aa9f) (generated via `git rev-parse --short HEAD`)

![alt text](image-5.png)
![alt text](image-6.png)

### **3.3. Static Analysis Tool Usage (SonarQube Community Edition)**

**Tool Used:** SonarQube Community Edition

**Summary of Findings:**

- **Quality Gate:** Passed (no critical/blocker issues)
- **Security:** 0 open issues
- **Reliability:** 0 open issues
- **Maintainability:** 6 open issues (all code smells)
- **Coverage:** 0.0% (no coverage data imported)
- **Duplications:** 0.0%

**Key Issues Detected:**
- **Payment_Processing.py**
  - Remove the unused local variable `expiry_date` (Low, L55)
  - Define a constant instead of duplicating the literal `"12/25"` 6 times (High, L129)
- **Restaurant_Browsing.py**
  - Unpack this comprehension expression (Low, L176, repeated)
- **User_Registration.py**
  - Unpack this comprehension expression (Low)
- All issues are maintainability/code smell related; no security or reliability issues detected.

**Technical Debt:** Minimal, with most issues requiring minor refactoring for maintainability.

**Code Review Fixes Commit Reference:** [`90bebaa`](https://github.com/Muditha-Kumara/SoftwareTesting/commit/90bebaa) (generated via `git rev-parse --short HEAD`)

**Screenshots:**  
- See attached SonarQube dashboard and issues screenshots for evidence.
...
**Reflection:**  
SonarQube’s results align with Pylint and manual review, confirming the absence of critical security or reliability issues but highlighting maintainability/code smell improvements. The most severe issue is the repeated use of a hardcoded literal, which should be refactored for maintainability.
...
**Code Review Fixes Commit Reference:** [`2206f25`](https://github.com/Muditha-Kumara/SoftwareTesting/commit/2206f25) (generated via `git rev-parse --short HEAD`)
...
**Code Review Fixes Commit Reference:** [`b233135`](https://github.com/Muditha-Kumara/SoftwareTesting/commit/b233135) (generated via `git rev-parse --short HEAD`)
