...
| **Group Members** | kumara(muditha.kumara@centria.fi), Chuks Henry |
| **Date Submitted** | 20/10/2025 |
| **App Version/Commit** | Alpha 2.0 (TDD Implementation) |
| **Code Repository** | https://github.com/Muditha-Kumara/SoftwareTesting/tree/2.1.phase2 |
...
✅ **84 comprehensive tests** written following Red-Green-Refactor cycle  
...
└── privet/
    ├── 2.1_ More advanced testings(phase 1).md  # Part 1 Report
    └── 2.1_ More advanced testings(phase 2).md  # This report
```
...
1. **Course Materials**: "Software Testing" - Aleksi Ukkola, Autumn 2025
2. **Assignment Document**: "2.1: More advanced testings.pdf"
3. **Python unittest Documentation**: https://docs.python.org/3/library/unittest.html
4. **TDD Best Practices**: Martin Fowler - "Test Driven Development"
5. **Code Coverage**: Coverage.py documentation
